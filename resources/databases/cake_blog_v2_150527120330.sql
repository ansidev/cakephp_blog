...
CREATE INDEX `us_role_key_idx` ON `cake_blog`.`users` (`roles_id` ASC);
...
START TRANSACTION;
USE `cake_blog`;
INSERT INTO `cake_blog`.`users` (`id`, `username`, `email`, `full_name`, `password`, `roles_id`, `created_at`, `updated_at`) VALUES (1, 'admin', 'admin@localhost', 'Administrator', '$2y$10$mAm8wAkoZvThj13ODxSlCuDtjgk9FEoUHjvRQG8jPipPLROgg2kd2', 1, '2015-04-18 09:18:00', '2015-04-18 09:18:00');
INSERT INTO `cake_blog`.`users` (`id`, `username`, `email`, `full_name`, `password`, `roles_id`, `created_at`, `updated_at`) VALUES (2, 'user', 'user@localhost', 'User', '$2y$10$FU/ZtI89O4YY9dkocNeomuLa6i8vXdJvMo6POyfgLP2lHfDrHWL3K', 3, '2015-04-18 09:18:00', '2015-04-18 09:18:00');
