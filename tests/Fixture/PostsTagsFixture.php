...
class PostsTagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'pt_post_key' => ['type' => 'index', 'columns' => ['post_id'], 'length' => []],
            'tag_idx' => ['type' => 'index', 'columns' => ['tag_id', 'post_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['tag_id', 'post_id'], 'length' => []],
            'pt_post_key' => ['type' => 'foreign', 'columns' => ['post_id'], 'references' => ['posts', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'pt_tag_key' => ['type' => 'foreign', 'columns' => ['tag_id'], 'references' => ['tags', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            'post_id' => 1,
            'tag_id' => 1,
            'created_at' => '2015-05-10 20:35:16',
            'updated_at' => '2015-05-10 20:35:16'
        ],
    ];
}
